...
PickPlaceTask::PickPlaceTask(const std::string& task_name) : TaskBase(task_name)
{
  current_state_stage_ = nullptr;
  attach_object_stage_ = nullptr;
}

bool PickPlaceTask::init(const ManipulationParameters& parameters)
{
  TASK_INFO("Initializing pick and place object pipeline");
