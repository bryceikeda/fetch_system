...
bool Add(executive::AddTwoInts::Request  &req,
         executive::AddTwoInts::Response &res)
{
  res.sum = req.a + req.b;
...
protected:
  ...
  actionlib::SimpleActionServer<executive::FibonacciAction> server_;
  std::string action_name_;
  // create messages that are used to published feedback/result
  executive::FibonacciFeedback feedback_;
  executive::FibonacciResult result_;
...
public:
  ...
  void executeCB(const executive::FibonacciGoalConstPtr &goal)
  {
