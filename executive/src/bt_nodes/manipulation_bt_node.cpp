#include <bt_nodes/bt_service_node.h>
#include <bt_nodes/bt_action_node.h>
#include <ros/ros.h>
#include <executive/AddTwoInts.h>
#include <executive/FibonacciAction.h>
...
class AddTwoIntsAction: public RosServiceNode<executive::AddTwoInts>
{

public:
  AddTwoIntsAction( ros::NodeHandle& handle, const std::string& node_name, const NodeConfiguration & conf):
  RosServiceNode<executive::AddTwoInts>(handle, node_name, conf) {}
...
class FibonacciServer: public RosActionNode<executive::FibonacciAction>
{

public:
  FibonacciServer( ros::NodeHandle& handle, const std::string& name, const NodeConfiguration & conf):
RosActionNode<executive::FibonacciAction>(handle, name, conf) {}
